...
function ResultModal(props) {
  ...
  const prizesCalc = (totalRank) => {
    ...
    return {
      firstClass:
        totalRank.firstClass > 0
          ? Math.floor(22500000000 / totalRank.firstClass)
          : 0, // 75%
      secondClass:
        totalRank.secondClass > 0
          ? Math.floor(3750000000 / totalRank.secondClass)
          : 0, // 12.5%
      thirdClass:
        totalRank.thirdClass > 0
          ? Math.floor(3750000000 / totalRank.thirdClass)
          : 0, // 12.5%
      fourthClass:
        totalRank.fourthClass > 0 ? 50000 * totalRank.fourthClass : 0,
